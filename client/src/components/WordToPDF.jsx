...
const WordToPDF = () => {
  ...
  const handleUpload = async () => {
    if (!file) return setError("Please select a Word file");
        ...
        <div className="mb-6 flex justify-center">
          ...
          >
            <path
              ...
              d="M3 16.5V6a2 2 0 012-2h6.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V16.5a2 2 0 01-2 2H5a2 2 0 01-2-2z"
            />
          </svg>
        </div>
